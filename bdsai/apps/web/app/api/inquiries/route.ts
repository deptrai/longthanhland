...
// Next API thin proxy (AD-10) — Story 6.1 + 6.2.
// POST /api/inquiries → NestJS (public, no auth required).
// GET  /api/inquiries → NestJS (seller list own inquiries, JWT required).
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  // Forward buyer IP for rate limiting.
