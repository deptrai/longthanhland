...
const HeroTitle = styled.h1`
  font-size: 2.5rem; font-weight: 700; margin: 0 0 0.75rem;
`;
const HeroSubtitle = styled.p`
  font-size: 1.125rem; opacity: 0.9; margin: 0 0 2rem;
...
const SearchInput = styled.input`
  ...
  font-size: 1rem; color: ${({ theme }) => theme.font.color.primary}; outline: none;
...
const SearchSelect = styled.select`
  ...
  background: ${({ theme }) => theme.background.primary}; font-size: 0.9375rem; color: ${({ theme }) => theme.font.color.secondary};
...
const SecLink = styled(Link)`
  font-size: 0.875rem; color: ${({ theme }) => theme.color.blue};
...
const ProjBadge = styled.span<{ $status: string }>`
  ...
  font-size: 0.75rem; font-weight: 600; color: ${({ theme }) => theme.font.color.inverted};
...
const ProjName = styled.h3`
  font-size: 1rem; font-weight: 700; margin: 0 0 0.25rem;
  color: ${({ theme }) => theme.font.color.primary};
`;
...
const FeatureTitle = styled.h3`
  font-size: 1.125rem; font-weight: 700; margin: 0 0 0.5rem;
  color: ${({ theme }) => theme.font.color.primary};
`;
...
const ListingPrice = styled.div`
  font-size: 0.9375rem; font-weight: 700; color: ${({ theme }) => theme.font.color.danger};
`;
