...
// Forward POST /api/marketplace/listings/:id/reject → NestJS (admin PENDING → REJECTED + audit log).
...
export async function POST(
  ...
  try {
    const res = await fetch(`${API_BASE_URL}/marketplace/listings/${id}/reject`, {
      method: 'POST',
